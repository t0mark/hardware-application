...
class SimpleSubscriber(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            ...
            '/rby1_wholebody_controller/state',
            self.listener_callback,
            10
        )

    def listener_callback(self, msg):
        GlobalVariable.torso_position_data = msg.actual.positions[0:6]
        GlobalVariable.right_position_data = msg.actual.positions[6:13]
        GlobalVariable.left_position_data = msg.actual.positions[13:20]
        GlobalVariable.head_position_data = msg.actual.positions[20:22]
            ...
            rc = rby1_sdk.RobotCommandBuilder().set_command(
                ...
                .set_head_command(
                    rby1_sdk.JointPositionCommandBuilder()
                        .set_command_header(rby1_sdk.CommandHeaderBuilder().set_control_hold_time(1))
                        .set_minimum_time(0.35)
                        .set_position(GlobalVariable.head_position_data)
                )
            )
